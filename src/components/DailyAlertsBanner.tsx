...
export default function DailyAlertsBanner() {
  ...
  return (
    <section className="w-full h-full flex flex-col" ref={containerRef}>
      <div className="flex-1 w-full bg-primary-deepBlue rounded-2xl p-6 md:p-8 shadow-xl border border-white/10 flex flex-col justify-between overflow-hidden relative">
            ...
            >
              <div className="bg-white/[0.07] rounded-xl px-4 py-3 border border-white/10">
                <p className="text-[12px] md:text-[13px] text-white/75 leading-relaxed text-center tracking-[0.01em]">
                  ...
                  Share icon in your browser menu. 2. Select{' '}
